...
public class LongConcurrentHashMap<V> extends AbstractLongMap<V>
    ...
    private static final long serialVersionUID = -7159209372912703942L;
     ...
     * @param m the map
     */
    public LongConcurrentHashMap(Map<Long, ? extends V> m) {
        this(Math.max((int) (m.size() / DEFAULT_LOAD_FACTOR) + 1, DEFAULT_INITIAL_CAPACITY),
                DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
        putAll(m);
    }

    public LongConcurrentHashMap(LongMap<? extends V> m) {
        this(Math.max((int) (m.size() / DEFAULT_LOAD_FACTOR) + 1, DEFAULT_INITIAL_CAPACITY),
                DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
        putAll(m);
    }
    ...
    public void putAll(LongMap<? extends V> m) {
        for (LongMap.Entry<? extends V> e : m.entrySet())
            put(e.getKey(), e.getValue());
    }
    ...
    public Set<LongMap.Entry<V>> entrySet() {
        Set<LongMap.Entry<V>> es = entrySet;
     ...
     */
    final class WriteThroughEntry extends AbstractLongMap.SimpleEntry<V> {

        private static final long serialVersionUID = 925805027123417085L;
        ...
        public V setValue(V value) {
            ...
            LongConcurrentHashMap.this.put(getKey(), value);
            return v;
        }
    }

    final class EntryIterator extends HashIterator implements Iterator<LongMap.Entry<V>> {
    ...
    final class KeySet extends AbstractLongSet {
        ...
        public int size() {
            return LongConcurrentHashMap.this.size();
        }

        public boolean isEmpty() {
            return LongConcurrentHashMap.this.isEmpty();
        }

        public boolean contains(long o) {
            return LongConcurrentHashMap.this.containsKey(o);
        }

        public boolean remove(long o) {
            return LongConcurrentHashMap.this.remove(o) != null;
        }

        public void clear() {
            LongConcurrentHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return LongConcurrentHashMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<LongMap.Entry<V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = LongConcurrentHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof LongMap.Entry))
                return false;
            LongMap.Entry<?> e = (LongMap.Entry<?>) o;
            return LongConcurrentHashMap.this.remove(e.getKey(), e.getValue());
        }
    ...
    static {
        ...
        try {
            ...
            SEGSHIFT_OFFSET = UNSAFE
                    .objectFieldOffset(LongConcurrentHashMap.class.getDeclaredField("segmentShift"));
            SEGMASK_OFFSET = UNSAFE
                    .objectFieldOffset(LongConcurrentHashMap.class.getDeclaredField("segmentMask"));
            SEGMENTS_OFFSET = UNSAFE
                    .objectFieldOffset(LongConcurrentHashMap.class.getDeclaredField("segments"));
        } catch (Exception e) {
            throw new Error(e);
        }
