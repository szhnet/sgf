...
public class IntHashMap<V> extends AbstractIntMap<V> implements IntMap<V>, Cloneable, Serializable {
    ...
    private void putAllForCreate(Map<Integer, ? extends V> m) {
    ...
    final Entry<V> removeMapping(Object o) {
        if (size == 0 || !(o instanceof IntMap.Entry))
            return null;
    ...
    static class Entry<V> implements IntMap.Entry<V> {
        ...
        public final int hashCode() {
            return Helper.intHash(getKey()) ^ Objects.hashCode(getValue());
        }
    ...
    private final class KeyIterator extends HashIterator implements IntIterator {
        public int next() {
            return nextEntry().getKey();
        }
    }

    private final class EntryIterator extends HashIterator implements Iterator<IntMap.Entry<V>> {
    ...
    private void writeObject(java.io.ObjectOutputStream s) throws IOException {
        ...
        if (size > 0) {
            for (IntMap.Entry<V> e : entrySet0()) {
                s.writeInt(e.getKey());
    ...
    private static final long serialVersionUID = 6156525963236800903L;
