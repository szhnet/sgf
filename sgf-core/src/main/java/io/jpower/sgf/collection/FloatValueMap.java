...
public interface FloatValueMap<K> {
    ...
    float get(Object key, float defaultRetVal);
    ...
    float put(K key, float value, float defaultRetVal);
    ...
    float remove(Object key, float defaultRetVal);
     ...
     */
    void putAll(Map<? extends K, Float> m);

    void putAll(FloatValueMap<K> m);
     ...
     */
    Set<FloatValueMap.Entry<K>> entrySet();
