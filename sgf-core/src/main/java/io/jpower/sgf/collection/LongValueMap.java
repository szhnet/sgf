 ...
 */
public interface LongValueMap<K> {
    ...
    long get(Object key, long defaultRetVal);
    ...
    long put(K key, long value, long defaultRetVal);
    ...
    long remove(Object key, long defaultRetVal);
     ...
     * {@link #put(K, long) put(k, v)} on this map once for each mapping from
     ...
     */
    void putAll(Map<? extends K, Long> m);

    void putAll(LongValueMap<K> m);
     ...
     */
    Set<LongValueMap.Entry<K>> entrySet();
